...
public class RunGame {
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	...
    	final  java.io.PrintStream ps = new java.io.PrintStream("GameLog.log");// log in file
        ...
        switch (indexFirstRace) {
            ...
            case 0:
                ...
                if (indexSecondRace == 0) {
                    ...
                    ps.println("The race of Elves is going to fight with the race of Orcs.");////////////
                } else {
                    ...
                    ps.println("The race of Elves is going to fight with the race of Undead.");//////////
                }
                break;
            ...
            case 1:
                ...
                if (indexSecondRace == 0) {
                    ...
                    ps.println("The race of Human is going to fight with the race of Orcs.");
                } else {
                    secondRace.addAll(createPlayers.createUndead());
                    firstRaceName = "Human";
                    secondRaceName = "Undead";
                    System.out.println("The race of Human is going to fight with the race of Undead.");
                    ps.println("The race of Human is going to fight with the race of Undead.");
                }
                break;
            ...
            case 2:
                ...
                if (indexSecondRace == 0) {
                    ...
                    ps.println("The race of Orcs is going to fight with the race of  Humans.");
                } else {
                    ...
                    ps.println("The race of Orcs is going to fight with the race of Elves.");
                }
                break;
            ...
            case 3:
                ...
                if (indexSecondRace == 0) {
                    ...
                    ps.println("The race of Undead is going to fight with the race of Elves.");
                } else {
                    secondRace.addAll(createPlayers.createHumans());
                    firstRaceName = "Undead";
                    secondRaceName = "Human";
                    System.out.println("The race of Undead is going to fight with the race of Humans.");
                    ps.println("The race of Undead is going to fight with the race of Humans.");
                }
                break;
        }
        ...
        if (firstMove == 0) {
            ...
            ps.println("The first move for " + firstRaceName + "!");
            activeRaces = 0;
        } else {
            System.out.println("The first move for " + secondRaceName + "!");
            ps.println("The first move for " + secondRaceName + "!");
            activeRaces = 1;
        }
        ...
        while ((!firstRace.isEmpty() || !privilegesFirstRace.isEmpty()) || (!secondRace.isEmpty() || !privilegesSecondRace.isEmpty())) {
            ...
            if (activeRaces == 0) {
                ...
                if (!privilegesFirstRace.isEmpty()) {
                    ...
                    //attacking victim
                    privilegesFirstRace.get(indexAttacker).attack(secondRace.get(indexVictim), firstRace.get(indexConfederate));
                    ...
                    if (secondRace.get(indexVictim).getHealth() <= 0) {
                        ...
                        ps.println("Soldier " + secondRace.get(indexVictim).getRace() + " " + secondRace.get(indexVictim).getSoldierType() + " " + secondRace.get(indexVictim).getName() + " died");
                    ...
                    //attacking victim
                    firstRace.get(indexAttacker).attack(secondRace.get(indexVictim), firstRace.get(indexConfederate));
                ...
                if (!privilegesSecondRace.isEmpty()) {
                    ...
                    //attacking victim
                    privilegesSecondRace.get(indexAttacker).attack(firstRace.get(indexVictim), secondRace.get(indexConfederate));
                    ...
                    if (firstRace.get(indexVictim).getHealth() <= 0) {
                        ...
                        ps.println("Soldier " + firstRace.get(indexVictim).getRace() + " " + firstRace.get(indexVictim).getSoldierType() + " " + firstRace.get(indexVictim).getName() + " died");
                    ...
                    //attacking victim
                    secondRace.get(indexAttacker).attack(firstRace.get(indexVictim), secondRace.get(indexConfederate));
        ...
        ps.println("The race of " + firstRaceName + " left with " + firstRace.size() + " soldiers");
        
        System.out.println("The race of " + secondRaceName + " left with " + secondRace.size() + " soldiers");
        ps.println("The race of " + secondRaceName + " left with " + secondRace.size() + " soldiers");
        
        if (firstRace.size() > 0) {
            System.out.println("Race of " + firstRaceName + " won.");
            ps.println("Race of " + firstRaceName + " won.");
        }
        if (secondRace.size() > 0) {
            System.out.println("Race of " + secondRaceName + " won.");
            ps.println("Race of " + secondRaceName + " won.");
        }
        if (firstRace.size() == secondRace.size()) {
            System.out.println("The game ended in a draw.");
            ps.println("The game ended in a draw.");
            ps.close();
        }
